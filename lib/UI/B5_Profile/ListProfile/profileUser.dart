      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Row(
                                  children: <Widget>[
                                    CircleAvatar(
                                        backgroundColor: const Color(0xFF72A065)
                                            .withOpacity(0.6),
                                        child: const Icon(
                                          Icons.photo,
                                          color: Colors.white,
            ...
            const Padding(
              padding: EdgeInsets.only(left: 25.0, top: 40.0, bottom: 10.0),
              child: Text(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                        ...
                        colors: [
                          const Color(0xFF72A065),
                          const Color(0xFF72A065).withOpacity(0.7)
                        ]),
